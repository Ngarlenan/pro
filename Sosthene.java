...
class Salaire {
	...
	public static void main(String[] args) {
		...
		p.ajouterEmploye(new Vendeur("daruis", "ngarlenan", 45, "1995", "12A31FS", 30000));		
		p.ajouterEmploye(new Representant("madire", "oumar", 25,"15B037FS", "2000" , 20000));
		p.ajouterEmploye(new Technicien("beasem", "cleo", 28, "1998", "17B001FS", 1000));
		p.ajouterEmploye(new Manutentionnaire("yelde", "georgette", 32, "1998","13B08FS", 45));
		p.ajouterEmploye(new TechnARisque("nadjirane", "courage", 28, "2000","16B001FS", 1000));
		p.ajouterEmploye(new ManutARisque("damlar", "heleen", 30, "2001", "15A67FS", 45));
